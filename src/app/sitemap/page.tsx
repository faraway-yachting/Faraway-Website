...
const SitemapPage = async () => {
  ...
  const pageCategories = {
    ...
    'Availability & Booking': [
      ...
      { name: 'Amadeus Cabin Charter Preference List', url: '/amacab' },
      { name: 'Hot Chilli Day Charter Preference List', url: '/hcday' },
      { name: 'Hot Chilli Overnight Charter Preference List', url: '/hcov' },
      { name: 'Amadeus Day Charter Preference List', url: '/amaday' },
      { name: 'Amadeus Overnight Charter Preference List', url: '/amaov' },
      { name: 'Mozart Day Charter Preference List', url: '/mozday' },
      { name: 'Mozart Overnight Charter Preference List', url: '/mozov' },
      { name: 'Shindig Day Charter Preference List', url: '/shday' },
      { name: 'Shindig Overnight Charter Preference List', url: '/shdov' },
      { name: 'Shindig Cabin Charter Preference List', url: '/shcab' },
      { name: 'Sail La Vie Day Charter Preference List', url: '/slvday' },
      { name: 'Sail La Vie Overnight Charter Preference List', url: '/slvov' },
      { name: 'Nauti by Nature Day Charter Preference List', url: '/nbnday' },
      { name: 'Nauti by Nature Overnight Charter Preference List', url: '/nbnov' },
    ],
