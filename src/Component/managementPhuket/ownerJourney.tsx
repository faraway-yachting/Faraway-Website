...
const PurchaseData: Purchase2Profit[] = [
    {
        id: "consultation",
        title: "Consultation",
        description: "We assess your goals—lifestyle, ROI, or both.",
    },
    {
        id: "selection",
        title: "Selection",
        description: "Guidance on the best vessel type, budget, and refit potential.",
    },
    {
        id: "acquisition",
        title: "Acquisition & Import",
        description: "Handling registration, customs, and insurance setup.",
    },
    {
        id: "compliance",
        title: "Refit & Compliance",
        description: "Preparing the yacht to meet Thai safety and charter standards",
    },
    {
        id: "charter",
        title: "Launch & Charter",
        description: "Listing on booking platforms, onboarding crew, and first charters.",
    },
    {
        id: "management",
        title: "Ongoing Management",
        description: "Preventive maintenance, transparent accounting, and steady income.",
    }
];

const OwnerJourney: React.FC = () => {
        ...
        <section className="pt-9 pb-18">
            <div className={combine(styles.container)}>
                ...
                <div className="text-center mb-16">
                    <HeadingContent
                        heading="The Owner Journey — From Purchase to Profit"
                         />
                </div>
                ...
                <div className="w-full relative">
                    ...
                    <div className="bg-white rounded-6xl shadow-xl p-6 flex items-start gap-4 max-w-7xl mt-6">
                            {/* Icon */}
                            ...
                            <div className="flex-1">
                                ...
                                From the first conversation to your first payout, everything is structured and data-driven.
                                </p>
                            </div>
                        </div>
                </div>
