                    ...
                    <div className="py-8 md:py-10 lg:py-15">
                        ...
                        <div className="text-center mb-6 md:mb-8 lg:mb-12">
                            <HeadingContent
                                ...
                                description="FEvery Overnight Boat Charter Phuket with Faraway is unique. From your very first inquiry, our team works with you to design the perfect journey. Before departure, you’ll meet with our expert sailors for a personalized briefing, using the latest weather forecast to shape the best itinerary together."
                            />
                        </div>
