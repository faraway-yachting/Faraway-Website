        ...
        <div>
            ...
            <div className="relative w-full bg-cover bg-end bg-no-repeat overflow-hidden bg-[url('/images/homeimg5.png')] px-8 md:px-6 flex items-center justify-start min-h-[70vh] md:min-h-[73vh] lg:min-h-[79vh] xl:min-h-[85vh] mt-5 md:mt-6 lg:mt-7 xl:mt-9">
                <div className="flex justify-start items-center max-w-5xl mx-auto w-full">
                    <div className="bg-[#012A50]/83 max-w-[30rem] w-full p-7 md:p-7 lg:p-8 ml-0">S
                        ...
                        <div className="flex items-center justify-center">
                            <button className="bg-zink text-white px-6 py-3 cursor-pointer rounded-lg font-semibold font-sourceSansPro hover:bg-[#D6AB62] transition-colors duration-300 border-2 border-white mt-5 md:mt-6 lg:mt-7 xl:mt-9 px-4 md:px-6 py-1.5 md:py-2.5">
