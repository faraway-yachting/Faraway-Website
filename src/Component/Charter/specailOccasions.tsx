...
const SpecialOccasionsCard = ({ title, description, icon: Icon }: { title: string; description: string; icon: IconType }) => (
    <div className="bg-white rounded-xl p-5 lg:p-3 xl:p-5 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 group relative overflow-hidden h-full flex flex-col">
        ...
        <div className="relative bg-zink py-8">
            <div className={combine("relative py-[60px]", styles.container)}>
                ...
                <div className={styles.containerLarge}>
                    <div className={combine(styles.grid4Col, "mt-12 items-stretch")}>
