            ...
            <div className="max-w-[78.5rem] mx-auto my-12 md:my-14 lg:my-16 xl:my-18 px-4 xl:px-0">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-6 lg:gap-6 xl:gap-16">
                    <div>
                        ...
                        <p className="text-[26px] md:text-[28px] lg:text-[32px] xl:text-[40px] font-bold font-playfair text-zink mb-3 uppercase">Privacy Policy</p>
                        <p className="text-base lg:text-lg xl:text-[22px] text-zink font-semibold text-inter mb-2">Last updated: October 31, 2024 </p>
                        <p className="text-base lg:text-lg xl:text-[19px] text-zink font-normal text-inter">This Privacy Policy describes our policies and procedures on the collection, use and disclosure of your information when You use the Service and tells You about Your privacy rights and how the law protects You.<br />
